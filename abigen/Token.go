...
func (_Abigen *AbigenCaller) AuctionHouse(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Abigen.contract.Call(opts, &out, "auctionHouse")
...
//
// Solidity: function auctionHouse() view returns(address)
func (_Abigen *AbigenSession) AuctionHouse() (common.Address, error) {
	return _Abigen.Contract.AuctionHouse(&_Abigen.CallOpts)
}

// AuctionHouse is a free data retrieval call binding the contract method 0xed9152c8.
//
// Solidity: function auctionHouse() view returns(address)
func (_Abigen *AbigenCallerSession) AuctionHouse() (common.Address, error) {
	return _Abigen.Contract.AuctionHouse(&_Abigen.CallOpts)
}
...
func (_Abigen *AbigenCaller) TokenQuantity(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Abigen.contract.Call(opts, &out, "tokenQuantity")
...
//
// Solidity: function tokenQuantity() view returns(uint256)
func (_Abigen *AbigenSession) TokenQuantity() (*big.Int, error) {
	return _Abigen.Contract.TokenQuantity(&_Abigen.CallOpts)
}

// TokenQuantity is a free data retrieval call binding the contract method 0x4600ca4c.
//
// Solidity: function tokenQuantity() view returns(uint256)
func (_Abigen *AbigenCallerSession) TokenQuantity() (*big.Int, error) {
	return _Abigen.Contract.TokenQuantity(&_Abigen.CallOpts)
}
...
func (_Abigen *AbigenCaller) TokenURI(opts *bind.CallOpts, tokenId *big.Int) (string, error) {
	var out []interface{}
	err := _Abigen.contract.Call(opts, &out, "tokenURI", tokenId)
...
//
// Solidity: function tokenURI(uint256 tokenId) view returns(string)
func (_Abigen *AbigenSession) TokenURI(tokenId *big.Int) (string, error) {
	return _Abigen.Contract.TokenURI(&_Abigen.CallOpts, tokenId)
}

// TokenURI is a free data retrieval call binding the contract method 0xc87b56dd.
//
// Solidity: function tokenURI(uint256 tokenId) view returns(string)
func (_Abigen *AbigenCallerSession) TokenURI(tokenId *big.Int) (string, error) {
	return _Abigen.Contract.TokenURI(&_Abigen.CallOpts, tokenId)
}
...
func (_Abigen *AbigenTransactor) Burn(opts *bind.TransactOpts, tokenId *big.Int) (*types.Transaction, error) {
	return _Abigen.contract.Transact(opts, "burn", tokenId)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 tokenId) returns()
func (_Abigen *AbigenSession) Burn(tokenId *big.Int) (*types.Transaction, error) {
	return _Abigen.Contract.Burn(&_Abigen.TransactOpts, tokenId)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 tokenId) returns()
func (_Abigen *AbigenTransactorSession) Burn(tokenId *big.Int) (*types.Transaction, error) {
	return _Abigen.Contract.Burn(&_Abigen.TransactOpts, tokenId)
}
...
func (_Abigen *AbigenTransactor) Mint(opts *bind.TransactOpts, to common.Address) (*types.Transaction, error) {
	return _Abigen.contract.Transact(opts, "mint", to)
}

// Mint is a paid mutator transaction binding the contract method 0x6a627842.
//
// Solidity: function mint(address to) returns(uint256)
func (_Abigen *AbigenSession) Mint(to common.Address) (*types.Transaction, error) {
	return _Abigen.Contract.Mint(&_Abigen.TransactOpts, to)
}

// Mint is a paid mutator transaction binding the contract method 0x6a627842.
//
// Solidity: function mint(address to) returns(uint256)
func (_Abigen *AbigenTransactorSession) Mint(to common.Address) (*types.Transaction, error) {
	return _Abigen.Contract.Mint(&_Abigen.TransactOpts, to)
}
...
func (_Abigen *AbigenTransactor) SafeTransferFrom0(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int, _data []byte) (*types.Transaction, error) {
	return _Abigen.contract.Transact(opts, "safeTransferFrom0", from, to, tokenId, _data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes _data) returns()
func (_Abigen *AbigenSession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, _data []byte) (*types.Transaction, error) {
	return _Abigen.Contract.SafeTransferFrom0(&_Abigen.TransactOpts, from, to, tokenId, _data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes _data) returns()
func (_Abigen *AbigenTransactorSession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, _data []byte) (*types.Transaction, error) {
	return _Abigen.Contract.SafeTransferFrom0(&_Abigen.TransactOpts, from, to, tokenId, _data)
}
...
func (_Abigen *AbigenTransactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, approved bool) (*types.Transaction, error) {
	return _Abigen.contract.Transact(opts, "setApprovalForAll", operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_Abigen *AbigenSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _Abigen.Contract.SetApprovalForAll(&_Abigen.TransactOpts, operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_Abigen *AbigenTransactorSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _Abigen.Contract.SetApprovalForAll(&_Abigen.TransactOpts, operator, approved)
}
...
func (_Abigen *AbigenTransactor) SetAuctionHouse(opts *bind.TransactOpts, _auctionHouse common.Address) (*types.Transaction, error) {
	return _Abigen.contract.Transact(opts, "setAuctionHouse", _auctionHouse)
}

// SetAuctionHouse is a paid mutator transaction binding the contract method 0xe76d8952.
//
// Solidity: function setAuctionHouse(address _auctionHouse) returns()
func (_Abigen *AbigenSession) SetAuctionHouse(_auctionHouse common.Address) (*types.Transaction, error) {
	return _Abigen.Contract.SetAuctionHouse(&_Abigen.TransactOpts, _auctionHouse)
}

// SetAuctionHouse is a paid mutator transaction binding the contract method 0xe76d8952.
//
// Solidity: function setAuctionHouse(address _auctionHouse) returns()
func (_Abigen *AbigenTransactorSession) SetAuctionHouse(_auctionHouse common.Address) (*types.Transaction, error) {
	return _Abigen.Contract.SetAuctionHouse(&_Abigen.TransactOpts, _auctionHouse)
}
