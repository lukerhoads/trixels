...
func (_Abigen *AbigenCaller) Balances(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Abigen.contract.Call(opts, &out, "balances", arg0)
...
//
// Solidity: function balances(address ) view returns(uint256)
func (_Abigen *AbigenSession) Balances(arg0 common.Address) (*big.Int, error) {
	return _Abigen.Contract.Balances(&_Abigen.CallOpts, arg0)
}

// Balances is a free data retrieval call binding the contract method 0x27e235e3.
//
// Solidity: function balances(address ) view returns(uint256)
func (_Abigen *AbigenCallerSession) Balances(arg0 common.Address) (*big.Int, error) {
	return _Abigen.Contract.Balances(&_Abigen.CallOpts, arg0)
}
...
func (_Abigen *AbigenCaller) Sales(opts *bind.CallOpts, arg0 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Abigen.contract.Call(opts, &out, "sales", arg0)
...
//
// Solidity: function sales(uint256 ) view returns(uint256)
func (_Abigen *AbigenSession) Sales(arg0 *big.Int) (*big.Int, error) {
	return _Abigen.Contract.Sales(&_Abigen.CallOpts, arg0)
}

// Sales is a free data retrieval call binding the contract method 0xb5f522f7.
//
// Solidity: function sales(uint256 ) view returns(uint256)
func (_Abigen *AbigenCallerSession) Sales(arg0 *big.Int) (*big.Int, error) {
	return _Abigen.Contract.Sales(&_Abigen.CallOpts, arg0)
}
...
func (_Abigen *AbigenTransactor) Distribute(opts *bind.TransactOpts, _contributors []IDistributorContributor, _tokenID *big.Int) (*types.Transaction, error) {
	return _Abigen.contract.Transact(opts, "distribute", _contributors, _tokenID)
}

// Distribute is a paid mutator transaction binding the contract method 0x8daf8596.
//
// Solidity: function distribute((address,uint256)[] _contributors, uint256 _tokenID) returns()
func (_Abigen *AbigenSession) Distribute(_contributors []IDistributorContributor, _tokenID *big.Int) (*types.Transaction, error) {
	return _Abigen.Contract.Distribute(&_Abigen.TransactOpts, _contributors, _tokenID)
}

// Distribute is a paid mutator transaction binding the contract method 0x8daf8596.
//
// Solidity: function distribute((address,uint256)[] _contributors, uint256 _tokenID) returns()
func (_Abigen *AbigenTransactorSession) Distribute(_contributors []IDistributorContributor, _tokenID *big.Int) (*types.Transaction, error) {
	return _Abigen.Contract.Distribute(&_Abigen.TransactOpts, _contributors, _tokenID)
}
